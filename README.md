...
- Удаление читателя запрещено при наличии записей в loans (ON DELETE RESTRICT); штрафы и бронирования удаляются каскадно
...
2. Создайте PostgreSQL базу данных и внесите данные о ней в `library_backend/settings.py`
